...
/**
 * Created by dongzhiquan on 2017/6/21.
 */
public class ReduceLine implements Job {
    @Override
...
//        Map<String, String> mapAll = RedisUtil.getHgetAllCluster(ResourceUtil.getProValueByNameAndKey("redis-db","tablerealtime"));
        ...
        for (Map.Entry<String, Map<String, String>> entry : result.entrySet()) {
            ...
            map.put("COLLECT_TIME", collect_time);//collect_time转为long

            json = JSON.toJSONString(map);
            //存入Cassandra
//            ReduceFrequency.save2BigDB("tableline",json);
        }
